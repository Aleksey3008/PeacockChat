...
public class ChatActivity extends AppCompatActivity {
    ...
    private PeacockMessageAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<PeacockMessage> peacockMessages = new ArrayList<>();
        adapter = new PeacockMessageAdapter(this,R.layout.message_item,
               peacockMessages );
        ...
        sendMessageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)  {
                PeacockMessage message = new PeacockMessage();
        ...
        messagesChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                PeacockMessage message = snapshot.getValue(PeacockMessage.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.sign_out:
                ...
                startActivity(new Intent(ChatActivity.this,SignActivity2.class));
                return true;
            default:
