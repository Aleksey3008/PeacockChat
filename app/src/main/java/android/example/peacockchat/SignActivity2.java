    ...
    private void loginSingUpUser(String email,String password) {
        if(loginModeActive){
            if (!passwordEditText.getText().toString().trim().equals(repeatPasswordEditText.
                ...
                Toast.makeText(this,"Введите ваш емейл",Toast.LENGTH_LONG).show();
...
//                            updateUI(null);
    ...
    public void toggleLoginMode(View view) {
        if(loginModeActive){
            ...
            loginSingUpButton.setText("Зарегистрируйтесь");
            toggleLogin.setText("Авторизоваться");
            repeatPasswordEditText.setVisibility(View.VISIBLE);
        } else {
            loginModeActive= true;
            loginSingUpButton.setText("Войти");
            toggleLogin.setText("Или зарегистрируйтесь");
